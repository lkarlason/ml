from runners.SmoothedTrainRunner import *
...
def parse_args_and_config():
    ...
    parser.add_argument('--runner', type=str, default='SmoothedTrainRunner', help='The runner to execute')
    parser.add_argument('--config', type=str, default='smoothed_train_mnist.yml', help='Path to config file')
    ...
    if not args.test:
        if not args.resume_training and not (args.runner == 'SampleRunner'):
